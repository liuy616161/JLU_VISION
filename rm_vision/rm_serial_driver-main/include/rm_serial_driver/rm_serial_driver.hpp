...
<<<<<<<< HEAD:rm_vision/rm_serial_driver-main/rm_serial_driver-main/include/rm_serial_driver/rm_serial_driver.hpp
========
#include "global_interface/msg/buff.hpp"
#include "global_interface/msg/serial_task.hpp"
>>>>>>>> 75f713b (clean):rm_vision/rm_serial_driver-main/include/rm_serial_driver/rm_serial_driver.hpp
...
>>>>>>>> 75f713b (clean):rm_vision/rm_serial_driver-main/include/rm_serial_driver/rm_serial_driver.hpp
  ...
  rclcpp::Publisher<std_msgs::msg::Int64>::SharedPtr gain_pub_;
  std_msgs::msg::Int64 gain_msg;// aim and buff are not the same gain
  ...
  bool initial_set_param_color = true;

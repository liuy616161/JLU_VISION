...
bool PnPSolver::solvePnP(const Armor & armor, cv::Mat & rvec, cv::Mat & tvec)
{
  ...
  image_armor_points.emplace_back(cv::Point2f(armor.landmarks[2],armor.landmarks[3]));
  image_armor_points.emplace_back(cv::Point2f(armor.landmarks[0],armor.landmarks[1]));
  image_armor_points.emplace_back(cv::Point2f(armor.landmarks[6],armor.landmarks[7]));
  image_armor_points.emplace_back(cv::Point2f(armor.landmarks[4],armor.landmarks[5]));

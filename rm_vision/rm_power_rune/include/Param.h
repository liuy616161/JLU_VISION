...
struct Param {
    ...
    inline static const double POWER_RUNE_RADIUS{730.0};
    ...
    inline static const double MIN_DISTANCE_TO_TARGET{2};
    ...
    inline static double MIN_ARMOR_ELLIPSE_AREA;
    inline static double MAX_ARMOR_ELLIPSE_AREA;

    inline static double MIN_ARMOR_ELLIPSE_CIRCULARITY;

...
void Param::load(const std::string& filename) {
    ...
    */
    ...
    fsArmor["ellipse"]["area"]["min"] >> MIN_ARMOR_ELLIPSE_AREA;
    fsArmor["ellipse"]["area"]["max"] >> MAX_ARMOR_ELLIPSE_AREA;
    fsArmor["ellipse"]["circularity"]["min"] >> MIN_ARMOR_ELLIPSE_CIRCULARITY;
    // centerR

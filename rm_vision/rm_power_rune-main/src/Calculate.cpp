...
Calculator::Calculator()
    : m_worldPoints{{0.0, 0.0, 0.0},
                    {(float)(-Param::ARMOR_RADIUS), (float)Param::ARMOR_RADIUS, 0.0},
                    {0.0, (float)(2*Param::ARMOR_RADIUS), 0.0},
                    {(float)(Param::ARMOR_RADIUS), (float)Param::ARMOR_RADIUS, 0.0},
...
bool Calculator::calculate(const Frame &frame, std::vector<cv::Point2f> &cameraPoints) {
    ...
    std::cout<<"start setFirstDetect"<<std::endl;
    setFirstDetect();
    std::cout<<"start angleCal"<<std::endl;
    angleCal();
    std::cout<<"start directionCal"<<std::endl;
    directionCal();

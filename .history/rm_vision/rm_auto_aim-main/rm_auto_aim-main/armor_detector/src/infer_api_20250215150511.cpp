    ...
    for (int anchor_idx = 0; anchor_idx < num_anchors; anchor_idx++)
    {
        ...
        if (box_prob >= BBOX_CONF_THRESH)
        {
          ...
          switch (box_color) {
            ...
            std::cout<<"point 2:"<<obj.landmarks[0]<<","<<obj.landmarks[1]<<std::endl;
            std::cout<<"point 3:"<<obj.landmarks[0]<<","<<obj.landmarks[1]<<std::endl;
            std::cout<<"point 4:"<<obj.landmarks[0]<<","<<obj.landmarks[1]<<std::endl;
